<?php
    $conn = mysqli_connect("localhost", "root", "toor", "lestarijaya");
    if (!$conn) {
            ...
            <div class="tempatTable">
                ...
                <table border="1px" class="mainTable table1" id="table1">
                    ...
                    <tr class="shortByName1" id="shortByName1">
                        <th class="nomerObat obat <?php if ($a % 2 == 0) : echo "colomPutih";?><?php endif; ?>"><h2><?= $a ?></h2></th>
                        ...
                        <th class="hargaObat obat <?php if ($a % 2 == 0) : echo "colomPutih"; ?><?php endif; ?>"><h2><?= $row["harga"]?></h2></th>
                    </tr>
                    <?php $a++ ?>
                    <?php endwhile; ?>
                </table>
